   ...
   handleButtonClick = (e) => {
    ...
    endGame = () => {
        ...
        const playerStats ={
            ...
            numberofAnswerdQuestions: state.numberofQuestions - (state.correctAnswers + state.wrongAnswers),
                ...
                <div className="questions">
                    ...
                    <div>
                        <p>
                           ...
                           <span className="right">{time.minutes}:{time.seconds}<span className="mdi mdi-clock-outline mdi-12px"></span></span>
                        </p>
                    </div>
